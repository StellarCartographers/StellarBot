...
import io.github.readonly.api.Embedder;
import io.github.readonly.api.Event;
...
public class Embed implements Embedder
{
    ...
    {
        this.fields.add(new Field(title, content, false));
        return this;
    }

    public Embed field(String title, Styler content)
    {
        this.fields.add(new Field(title, content.string(), false));
        return this;
    }

    public Embed fieldInline(String title, String content)
    {
        this.fields.add(new Field(title, content, true));
        return this;
    }

    public Embed fieldInline(String title, Styler content)
    {
        this.fields.add(new Field(title, content.string(), true));
        return this;
    }

    public Embed blankInlineField()
    {
        this.fields.add(new Field(EmbedBuilder.ZERO_WIDTH_SPACE, EmbedBuilder.ZERO_WIDTH_SPACE, true));
        return this;
    }

    public Embed blankField()
    {
        this.fields.add(new Field(EmbedBuilder.ZERO_WIDTH_SPACE, EmbedBuilder.ZERO_WIDTH_SPACE, false));
        return this;
    }
    ...
    public final MessageEmbed toEmbed()
    {
        ...
        {
            this.builder.getFields().add(this.fields.indexOf(field), field);
        }
    ...
    public static class Condition<T> implements Supplier<T>
    {
        ...
        {
            return new Condition<>(obj, p -> p != null);
        }
